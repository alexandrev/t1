...
insert into SN_VERSION (SPOTFIRE_VERSION, SCHEMA_VERSION) values ('68.2.13101.3747', '468');

-- Special groups
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('19e7e430-9997-11da-fbc4-0010ac110215', 'Everyone', 'SPOTFIRE', 'Everyone', 0, 1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('fed6b2b0-a9e1-11da-8ed2-0010ac110222', 'Administrator', 'SPOTFIRE', 'Administrator', 0, 1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('a92097e0-07a7-11db-fd44-0010c0a8019b', 'Library Administrator', 'SPOTFIRE', 'Library Administrator', 0,
    1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
...
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('5f1879fa-2cca-4d03-b47b-ef03e55d927e', 'Scheduling and Routing Administrator', 'SPOTFIRE', 
    'Scheduling and Routing Administrator', 0, 1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('6c677f0f-3cbe-4615-85be-8366c7ce3181', 'Script Author', 'SPOTFIRE', 'Script Author', 0, 1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('2cbe823f-1507-4b56-a822-621f431ee061', 'Custom Query Author', 'SPOTFIRE', 'Custom Query Author', 0, 1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('3bf79f12-1842-41d5-9002-fa1d70ce071c', 'Anonymous User', 'SPOTFIRE', 'Anonymous User', 0, 1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
  values ('5a544e10-f305-408b-ae0c-a602eec4ed4f', 'System Account', 'SPOTFIRE', 'System Account', 0, 1, (select TS from UTC_TIME));
insert into GROUPS (GROUP_ID, GROUP_NAME, DOMAIN_NAME, DISPLAY_NAME, CONNECTED, FIXED, CREATED)
...
insert into USERS (USER_ID, USER_NAME, DOMAIN_NAME, DISPLAY_NAME, ENABLED, FIXED, CREATED) 
  values ('6679bcea-758d-4b72-8d50-32dfa6621239', 'guest', 'ANONYMOUS', 'Guest', 0, 1, (select TS from UTC_TIME));
